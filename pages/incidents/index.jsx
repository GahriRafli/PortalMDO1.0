...
export default function Incident(props) {
  ...
  return (
    <LayoutPage session={props.user} pageTitle="Incident - Shield">
      <LayoutPageHeader variant="alternate" pageTitle={"Incident Report"}>
                    ...
                    <div className="grid grid-cols-6 gap-4 ">
                      <div className="col-span-6 sm:col-span-6 lg:col-span-2 xxl:col-span-1">
                        ...
                        <InputTag
                          ...
                          placeholder={`${props.totalCount} records...`}
                          prefix={
                            <SearchIcon
                              className="w-5 h-5 text-gray-400"
                              aria-hidden="true"
...
export const getServerSideProps = withSession(async function ({ req, query }) {
  ...
  let url = new URL(`${process.env.NEXT_PUBLIC_API_URL_V2}/incidents`);

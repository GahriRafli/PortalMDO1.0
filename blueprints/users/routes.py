...
api.add_resource(userControllers.UserRegistration, "/v1.0/users/register")
api.add_resource(userControllers.UserList, "/v1.0/users/list")
api.add_resource(userControllers.UserUpdate, "/v1.0/users/update")